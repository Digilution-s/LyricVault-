...
import { X, FolderHeart, Lock, Globe, Sparkles, Loader2, Image as ImageIcon } from 'lucide-react';
...
export const CreateCollectionModal: React.FC<CreateCollectionModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setDescription('');
      setPrivacy('public');
      setSelectedGradient(COLLECTION_GRADIENTS[0].class);
      setCoverUrl('');
      onClose();
    } catch (err: any) {
      ...
      >
        ...
        <div className="flex items-center justify-between pb-4 border-b border-[var(--border-color)]">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)]">Organize your lyrics into thematic anthologies.</p>
            </div>
          </div>
        ...
        <div className="mt-4">
          ...
          >
            <div className="flex items-center justify-between z-10">
              ...
              <span className="text-[11px] font-medium opacity-90">0 items</span>
            </div>
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              placeholder="e.g. Late Night Musings, Heartbreak Stanzas..."
              value={title}
          ...
          <div>
            ...
            <textarea
              rows={2}
              placeholder="Describe the mood, theme, or story behind these lyrics..."
              value={description}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[10px] opacity-75">Visible to all Vault visitors</div>
                </div>
              </button>
